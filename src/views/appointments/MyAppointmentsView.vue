...
<template>
    <h2 class="text-4xl font-extrabold text-white mt-10">Mis citas pendientes</h2>
    <p class="text-white text-lg mt-5">A continuación podras administrar tus proximas citas</p>
